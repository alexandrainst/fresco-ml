...
public class MnistTestContext {
  ...
  public static final int DEFAULT_GLOBAL_EPOCHS = 5;
  ...
  private void createConf() {    
    ...
    this.conf = new NeuralNetConfiguration.Builder()
        .seed(seed)
        .l2(learningRate * regularization)
        ...
        .backpropType(BackpropType.Standard) // InputType.convolutional for normal image
//        .backpropType(true)
//        .pretrain(false)
        .build();    
